...
我们可以发现，对于访问到的每个坐标点(x, y)，假设从起点到(x, y)的最小代价为d。如果选择直接移动到(targetX, targetY)，那么总代价就是d + |x - targetX| + |y - targetY|。如果选择经过某条特殊路径(x_1, y_1) \rightarrow (x_2, y_2)，那么我们需要可以花费|x - x_1| + |y - y_1| + cost的代价，从(x, y)移动到(x_2, y_2)。
