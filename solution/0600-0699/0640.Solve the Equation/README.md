...
将方程equation按照等号 “=” 切分为左右两个式子，分别算出左右两个式子中 "x" 的系数x_i，以及常数的值y_i。

那么方程转换为等式x_1 \times x + y_1 = x_2 \times x + y_2。

-   当x_1 = x_2：若y_1 \neq y_2，方程无解；若y_1=y_2，方程有无限解。
-   当x_1 \neq x_2：方程有唯一解x=\frac{y_2-y_1}{x_1-x_2}。
