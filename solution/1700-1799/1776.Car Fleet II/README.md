...
当我们遍历到第i辆车时，如果第i辆车的速度大于栈顶元素对应的车辆j的速度，此时我们计算两车相遇的时间，记为t。如果车辆j与右边车辆不会相遇，或者t小于等于j与右辆车相遇的时间，说明车辆i可以在t时间追上车辆j，更新答案。否则，说明车辆i不会与车辆j相遇，我们将车辆j出栈，继续判断车辆i与栈顶元素对应的车辆相遇的时间。如果栈为空，说明车辆i不会与任何车辆相遇，更新答案为-1。最后，将车辆i入栈。

遍历完所有车辆后，即可得到答案。

时间复杂度O(n)，空间复杂度O(n)。其中n为车辆数量。
