...
我们假设选取了某一个工资组，总工作质量为 `tot`，总支付金额为 `c`。每个工人的工作质量为q_i，工资为w_i。那么，对于此工资组的每个工人，均满足c\times \frac{q_i}{tot} \ge w_i。即c\ge tot\times \frac{w_i}{q_i}。
...
时间复杂度O(n\log n)，空间复杂度O(n)。其中n是工人数。
